...
import net.extrabiomes.terraincontrol.customobjects.Branch;
import net.extrabiomes.terraincontrol.customobjects.CustomObject;
import net.extrabiomes.terraincontrol.customobjects.CustomObjectCoordinate;
import net.extrabiomes.terraincontrol.customobjects.Rotation;
import net.extrabiomes.terraincontrol.customobjects.StructuredCustomObject;
import net.extrabiomes.terraincontrol.customobjects.CustomObjectCoordinate.SpawnHeight;
import net.extrabiomes.terraincontrol.customobjects.bo3.BO3Settings.OutsideSourceBlock;
import net.extrabiomes.terraincontrol.customobjects.bo3.BO3Settings.SpawnHeightSetting;
