...
package net.extrabiomes.utility;
...
public enum LogWriter {
    ...
    private void init() {
        ...
        logger.get().setParent(ExtrabiomesXL.proxy.getFMLLogger());
    }
     ...
     * @see java.util.Formatter Formatter
     */
    public void log(final Level level, final String format, final Object... data) {
